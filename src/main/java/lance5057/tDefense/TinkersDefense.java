...
public class TinkersDefense {
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        block_ArmorAnvil = new FinishingAnvil()
                .setHardness(4.0F)
        ...
        // Recipes
        GameRegistry.addShapedRecipe(new ItemStack(block_CrestMount), new Object[] {
            "xxx",
            "-i-",
            "---",
            'x',
            new ItemStack(TinkerTools.toughRod, 1, 1),
            'i',
            new ItemStack(TinkerTools.toolRod, 1, 1)
        });
        GameRegistry.addShapedRecipe(new ItemStack(block_ArmorAnvil), new Object[] {
            "ai-",
            "lr-",
            "---",
            'r',
            new ItemStack(TinkerTools.toughRod, 1, 0),
            'a',
            Blocks.anvil,
            'i',
            Items.iron_ingot,
        ...
        GameRegistry.addShapedRecipe(
                new ItemStack(block_aeonsteelBlock), new Object[] {"xxx", "xxx", "xxx", 'x', item_aeonsteelIngot});
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_aeonsteelIngot, 9), new Object[] {new ItemStack(block_aeonsteelBlock)});
        GameRegistry.addShapedRecipe(
                new ItemStack(block_queensgoldBlock), new Object[] {"xxx", "xxx", "xxx", 'x', item_queensgoldIngot});
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_queensgoldIngot, 9), new Object[] {new ItemStack(block_queensgoldBlock)});
        GameRegistry.addShapedRecipe(
                new ItemStack(block_dogbeariumBlock), new Object[] {"xxx", "xxx", "xxx", 'x', item_dogbeariumIngot});
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_greenmintcane, 9, 3), new Object[] {new ItemStack(block_greenmintBlock)});
    ...
    public void init(FMLInitializationEvent e) {
        ...
        if (config.mossEnabled || config.mossHard) {
            ...
            if (config.mossHard) {
                GameRegistry.addShapedRecipe(TConstructRegistry.getItemStack("mossBall"), new Object[] {
                    "hmh",
                    "msm",
                    "hmh",
                    'h',
        ...
        TConstructClientRegistry.stencilButtons2.add(
                new StencilGuiElement(0, 0, stencils[0], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2.add(
                new StencilGuiElement(0, 0, stencils[1], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2.add(
                new StencilGuiElement(0, 0, stencils[2], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2.add(
                new StencilGuiElement(0, 0, stencils[3], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2.add(
                new StencilGuiElement(0, 0, stencils[4], "tinkersdefense", "textures/gui/icons.png"));
        ...
        TConstructRegistry.addToolMaterial(
                config.AeonsteelMatID, "aeonsteel", 4, 822, 1100, 3, 1.6F, 2, 0f, LIGHT_PURPLE.toString(), 0xb565e6);
        ...
        Smeltery.addMelting(
                block_aeonsteelBlock, 0, 500, new FluidStack(moltenaeonsteel, TConstruct.ingotLiquidValue * 9));
        ...
        Smeltery.addAlloyMixing(new FluidStack(moltenaeonsteel, 144), new FluidStack[] {
        ...
        TConstructRegistry.addToolMaterial(
                config.QueensGoldMatID, "queensgold", 3, 100, 500, 2, 1.0F, 0, 0f, GOLD.toString(), 0xeaee57);
        ...
        Smeltery.addMelting(
                block_queensgoldBlock, 0, 500, new FluidStack(moltenqueensgold, TConstruct.ingotLiquidValue * 9));
        ...
        Smeltery.addAlloyMixing(new FluidStack(moltenqueensgold, 144 * 8), new FluidStack[] {
        ...
        TConstructRegistry.addToolMaterial(
                config.DogbeariumMatID, "dogbearium", 4, 600, 800, 2, 1.6F, 0, -2f, DARK_RED.toString(), 0x754200);
        ...
        Smeltery.addMelting(
                block_dogbeariumBlock, 0, 500, new FluidStack(moltendogbearium, TConstruct.ingotLiquidValue * 9));
        ...
        Smeltery.addAlloyMixing(new FluidStack(moltendogbearium, 144 * 2), new FluidStack[] {
        ...
        TConstructRegistry.addToolMaterial(
                config.RedMintMatID, "redmint", 1, 50, 10, 0, 0F, 0, 0f, DARK_RED.toString(), 0xFF0000);
        ...
        TConstructRegistry.addToolMaterial(
                config.GreenMintMatID, "greenmint", 1, 50, 10, 0, 0F, 0, 0f, DARK_RED.toString(), 0x5bde4b);
        ...
        Smeltery.addMelting(
                block_greenmintBlock, 0, 500, new FluidStack(moltengreenmint, TConstruct.ingotLiquidValue * 9));
        ...
        // Cloth
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                0, 2, new ItemStack(Blocks.wool, 1, 0), new ItemStack(TinkersDefense.partCloth, 1, 0), 0xffffff));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                1, 2, new ItemStack(Blocks.wool, 1, 1), new ItemStack(TinkersDefense.partCloth, 1, 1), 0xe08c54));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                2, 2, new ItemStack(Blocks.wool, 1, 2), new ItemStack(TinkersDefense.partCloth, 1, 2), 0xc16bc9));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                3, 2, new ItemStack(Blocks.wool, 1, 3), new ItemStack(TinkersDefense.partCloth, 1, 3), 0x8ba4d6));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                4, 2, new ItemStack(Blocks.wool, 1, 4), new ItemStack(TinkersDefense.partCloth, 1, 4), 0xcfc231));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                5, 2, new ItemStack(Blocks.wool, 1, 5), new ItemStack(TinkersDefense.partCloth, 1, 5), 0x50c447));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                6, 2, new ItemStack(Blocks.wool, 1, 6), new ItemStack(TinkersDefense.partCloth, 1, 6), 0xdea5b3));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                7, 2, new ItemStack(Blocks.wool, 1, 7), new ItemStack(TinkersDefense.partCloth, 1, 7), 0x494949));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                8, 2, new ItemStack(Blocks.wool, 1, 8), new ItemStack(TinkersDefense.partCloth, 1, 8), 0xb6baba));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                9, 2, new ItemStack(Blocks.wool, 1, 9), new ItemStack(TinkersDefense.partCloth, 1, 9), 0x3782a1));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                10, 2, new ItemStack(Blocks.wool, 1, 10), new ItemStack(TinkersDefense.partCloth, 1, 10), 0x9453c9));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                11, 2, new ItemStack(Blocks.wool, 1, 11), new ItemStack(TinkersDefense.partCloth, 1, 11), 0x3543a6));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                12, 2, new ItemStack(Blocks.wool, 1, 12), new ItemStack(TinkersDefense.partCloth, 1, 12), 0x5c3a24));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                13, 2, new ItemStack(Blocks.wool, 1, 13), new ItemStack(TinkersDefense.partCloth, 1, 13), 0x3e5420));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                14, 2, new ItemStack(Blocks.wool, 1, 14), new ItemStack(TinkersDefense.partCloth, 1, 14), 0xb03e38));
        TConstructRegistry.addCustomMaterial(new ClothMaterial(
                15, 2, new ItemStack(Blocks.wool, 1, 15), new ItemStack(TinkersDefense.partCloth, 1, 15), 0x242222));
        ...
        TConstructRegistry.addToolRecipe(
                tool_heaterShield, partArmorplate, TinkerTools.toughRod, partArmorplate, partRivet);

        // Wrench
        TConstructRegistry.addToolRecipe(tool_wrench, TinkerTools.handGuard, TinkerTools.toolRod, TinkerTools.binding);

        TConstructRegistry.addToolRecipe(
                tool_shears, TinkerTools.knifeBlade, TinkerTools.binding, TinkerTools.knifeBlade);
