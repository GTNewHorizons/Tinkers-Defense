...
public class TinkersDefense {
    ...
    public static String[] colors = { "black", "red", "green", "brown", "blue", "purple", "cyan", "lightgray", "gray",
    ...
    @SidedProxy(
            clientSide = "lance5057.tDefense.proxy.ClientProxy",
            serverSide = "lance5057.tDefense.proxy.CommonProxy")
    ...
    public void preInit(FMLPreInitializationEvent e) {
        tabName = new CreativeTabs("tabName") {
            ...
            public Item getTabIconItem() {
                return ToolBuilder.instance.buildTool(
                        ...
                        new ItemStack(TinkersDefense.partArmorplate, 1, 2),
                        new ItemStack(TinkersDefense.partRivet, 1, 2),
                        "TDTab").getItem();
            }
        };
        ...
        // Blocks
        block_CrestMount = new CrestMount().setHardness(4.0F).setStepSound(Block.soundTypeStone)
                .setBlockName("crestmount").setCreativeTab(tabName);
        block_ArmorAnvil = new FinishingAnvil().setHardness(4.0F).setStepSound(Block.soundTypeAnvil)
                .setBlockName("armoranvil").setCreativeTab(tabName);
        block_JewelersBench = new JewelersBench().setHardness(4.0F).setStepSound(Block.soundTypeWood)
                .setBlockName("jewelersbench").setCreativeTab(tabName);

        block_aeonsteelBlock = new AeonSteelBlock(Material.iron).setHardness(4.0F).setStepSound(Block.soundTypeMetal)
                .setBlockName("aeonsteelblock").setCreativeTab(tabName)
                .setBlockTextureName(Reference.MOD_ID + ":aeonsteelblock");
        block_queensgoldBlock = new QueensGoldBlock(Material.iron).setHardness(4.0F).setStepSound(Block.soundTypeMetal)
                .setBlockName("queensgoldblock").setCreativeTab(tabName)
                .setBlockTextureName(Reference.MOD_ID + ":queensgoldblock");
        block_dogbeariumBlock = new DogbeariumBlock(Material.iron).setHardness(4.0F).setStepSound(Block.soundTypeMetal)
                .setBlockName("dogbeariumblock").setCreativeTab(tabName)
                .setBlockTextureName(Reference.MOD_ID + ":dogbeariumblock");
        block_redmintBlock = new RedMintBlock(Material.iron).setHardness(4.0F).setStepSound(Block.soundTypeMetal)
                .setBlockName("redmintblock").setCreativeTab(tabName)
                .setBlockTextureName(Reference.MOD_ID + ":redmintblock");
        block_greenmintBlock = new GreenMintBlock(Material.iron).setHardness(4.0F).setStepSound(Block.soundTypeMetal)
        ...
        item_aeonsteelIngot = new Item().setCreativeTab(tabName).setMaxStackSize(64)
                .setUnlocalizedName("aeonsteelingot").setTextureName(Reference.MOD_ID + ":aeonsteelingot");
        item_queensgoldIngot = new Item().setCreativeTab(tabName).setMaxStackSize(64)
                .setUnlocalizedName("queensgoldingot").setTextureName(Reference.MOD_ID + ":queensgoldingot");
        item_dogbeariumIngot = new Item().setCreativeTab(tabName).setMaxStackSize(64)
                .setUnlocalizedName("dogbeariumingot").setTextureName(Reference.MOD_ID + ":dogbeariumingot");
        item_redmintcane = new Item().setCreativeTab(tabName).setMaxStackSize(64).setUnlocalizedName("redmintcane")
                .setTextureName(Reference.MOD_ID + ":redmintcane");
        item_redmintIngot = new Item().setCreativeTab(tabName).setMaxStackSize(64).setUnlocalizedName("redmintIngot")
                .setTextureName(Reference.MOD_ID + ":redmintingot");
        item_greenmintcane = new Item().setCreativeTab(tabName).setMaxStackSize(64).setUnlocalizedName("greenmintcane")
                .setTextureName(Reference.MOD_ID + ":greenmintcane");
        item_greenmintIngot = new Item().setCreativeTab(tabName).setMaxStackSize(64)
                .setUnlocalizedName("greenmintIngot").setTextureName(Reference.MOD_ID + ":greenmintingot");

        // Fluids
        moltenaeonsteel = new Fluid("moltenaeonsteel").setLuminosity(15).setDensity(3000).setViscosity(6000)
                .setTemperature(1300);
        moltenqueensgold = new Fluid("moltenqueensgold").setLuminosity(15).setDensity(3000).setViscosity(6000)
                .setTemperature(1300);
        moltendogbearium = new Fluid("moltendogbearium").setLuminosity(15).setDensity(3000).setViscosity(6000)
                .setTemperature(1300);
        moltenredmint = new Fluid("moltenredmint").setLuminosity(15).setDensity(3000).setViscosity(6000)
                .setTemperature(1300);
        moltengreenmint = new Fluid("moltengreenmint").setLuminosity(15).setDensity(3000).setViscosity(6000)
                .setTemperature(1300);
        ...
        GameRegistry.addShapedRecipe(
                new ItemStack(block_CrestMount),
                new Object[] { "xxx", "-i-", "---", 'x', new ItemStack(TinkerTools.toughRod, 1, 1), 'i',
                        new ItemStack(TinkerTools.toolRod, 1, 1) });
        GameRegistry.addShapedRecipe(
                new ItemStack(block_ArmorAnvil),
                new Object[] { "ai-", "lr-", "---", 'r', new ItemStack(TinkerTools.toughRod, 1, 0), 'a', Blocks.anvil,
                        'i', Items.iron_ingot, 'l', Blocks.log });
        GameRegistry.addShapedRecipe(
                new ItemStack(block_aeonsteelBlock),
                new Object[] { "xxx", "xxx", "xxx", 'x', item_aeonsteelIngot });
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_aeonsteelIngot, 9),
                new Object[] { new ItemStack(block_aeonsteelBlock) });
        GameRegistry.addShapedRecipe(
                new ItemStack(block_queensgoldBlock),
                new Object[] { "xxx", "xxx", "xxx", 'x', item_queensgoldIngot });
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_queensgoldIngot, 9),
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_dogbeariumIngot, 9),
                new Object[] { new ItemStack(block_dogbeariumBlock) });
        GameRegistry.addShapedRecipe(
                new ItemStack(block_redmintBlock),
                new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(item_redmintcane, 1, 2) });
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_redmintcane, 9, 2),
                new Object[] { new ItemStack(block_redmintBlock) });
        GameRegistry.addShapedRecipe(
                new ItemStack(block_greenmintBlock),
                new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(item_greenmintcane, 1, 3) });
        GameRegistry.addShapelessRecipe(
                new ItemStack(item_greenmintcane, 9, 3),
    ...
    public void init(FMLInitializationEvent e) {
        ...
        if (config.mossEnabled || config.mossHard) {
            ...
            while (recipe.hasNext()) {
                ...
                if (next != null) {
                    if (next.getItem() == TConstructRegistry.getItemStack("mossBall").getItem()
                            && next.getItemDamage() == TConstructRegistry.getItemStack("mossBall").getItemDamage()) {
                        recipe.remove();
                    }
                }
            }
            ...
            if (config.mossHard) {
                GameRegistry.addShapedRecipe(
                        TConstructRegistry.getItemStack("mossBall"),
                        new Object[] { "hmh", "msm", "hmh", 'h', new ItemStack(TinkerArmor.heartCanister, 1, 3), 'm',
                                new ItemStack(Blocks.mossy_cobblestone, 1, 0), 's',
        ...
        TConstructClientRegistry.stencilButtons2
                .add(new StencilGuiElement(0, 0, stencils[0], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2
                .add(new StencilGuiElement(0, 0, stencils[1], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2
                .add(new StencilGuiElement(0, 0, stencils[2], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2
                .add(new StencilGuiElement(0, 0, stencils[3], "tinkersdefense", "textures/gui/icons.png"));
        TConstructClientRegistry.stencilButtons2
                .add(new StencilGuiElement(0, 0, stencils[4], "tinkersdefense", "textures/gui/icons.png"));

        final PatternBuilder pb = PatternBuilder.instance;

        // Shields
        TConstructClientRegistry.toolButtons.add(
                new ToolGuiElement(
                        0,
                        0,
                        6,
        ...
        TConstructClientRegistry.tierTwoButtons.add(
                new ToolGuiElement(
                        5,
                        1,
                        6,
        ...
        Smeltery.addMelting(
                ...
                0,
                500,
                new FluidStack(moltenaeonsteel, TConstruct.ingotLiquidValue * 9));
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "aeonsteel",
                new ItemStack(TinkerTools.toolShard, 1, config.AeonsteelMatID),
                new ItemStack(TinkerTools.toolRod, 1, config.AeonsteelMatID),
                config.AeonsteelMatID);

        Smeltery.addAlloyMixing(
                new FluidStack(moltenaeonsteel, 144),
                new FluidStack[] { new FluidStack(TinkerSmeltery.moltenAlumiteFluid, 144),
        ...
        Smeltery.addMelting(
                ...
                0,
                500,
                new FluidStack(moltenqueensgold, TConstruct.ingotLiquidValue * 9));
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "queensgold",
                new ItemStack(TinkerTools.toolShard, 1, config.QueensGoldMatID),
                new ItemStack(TinkerTools.toolRod, 1, config.QueensGoldMatID),
                config.QueensGoldMatID);

        Smeltery.addAlloyMixing(
                new FluidStack(moltenqueensgold, 144 * 8),
                new FluidStack[] { new FluidStack(TinkerSmeltery.moltenGoldFluid, 144 * 8),
        ...
        Smeltery.addMelting(
                ...
                0,
                500,
                new FluidStack(moltendogbearium, TConstruct.ingotLiquidValue * 9));
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "dogbearium",
                new ItemStack(TinkerTools.toolShard, 1, config.DogbeariumMatID),
                new ItemStack(TinkerTools.toolRod, 1, config.DogbeariumMatID),
                config.DogbeariumMatID);

        Smeltery.addAlloyMixing(
                new FluidStack(moltendogbearium, 144 * 2),
                new FluidStack[] { new FluidStack(TinkerSmeltery.moltenArditeFluid, 144),
        ...
        Smeltery.addMelting(
                new ItemStack(item_redmintcane, 1, 0),
                block_redmintBlock,
                0,
                250,
                new FluidStack(moltenredmint, TConstruct.chunkLiquidValue));
        Smeltery.addMelting(
        ...
        TConstructRegistry.getBasinCasting().addCastingRecipe(
                ...
                new FluidStack(moltenredmint, TConstruct.ingotLiquidValue * 9),
                100);
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "redmint",
                new ItemStack(TinkerTools.toolShard, 1, config.RedMintMatID),
                new ItemStack(TinkerTools.toolRod, 1, config.RedMintMatID),
                config.RedMintMatID);
        ...
        Smeltery.addMelting(
                new ItemStack(item_greenmintcane, 1, 0),
                block_greenmintBlock,
                0,
                250,
                new FluidStack(moltengreenmint, TConstruct.chunkLiquidValue));
        Smeltery.addMelting(
        ...
        Smeltery.addMelting(
                ...
                0,
                500,
                new FluidStack(moltengreenmint, TConstruct.ingotLiquidValue * 9));
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "greenmint",
                new ItemStack(TinkerTools.toolShard, 1, config.GreenMintMatID),
                new ItemStack(TinkerTools.toolRod, 1, config.GreenMintMatID),
                config.GreenMintMatID);
        ...
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 0),
                        0xffffff));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        1,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 1),
                        0xe08c54));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        2,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 2),
                        0xc16bc9));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        3,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 3),
                        0x8ba4d6));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        4,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 4),
                        0xcfc231));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        5,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 5),
                        0x50c447));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        6,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 6),
                        0xdea5b3));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        7,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 7),
                        0x494949));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        8,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 8),
                        0xb6baba));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        9,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 9),
                        0x3782a1));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        10,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 10),
                        0x9453c9));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        11,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 11),
                        0x3543a6));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        12,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 12),
                        0x5c3a24));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        13,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 13),
                        0x3e5420));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        14,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 14),
                        0xb03e38));
        TConstructRegistry.addCustomMaterial(
                new ClothMaterial(
                        15,
                        ...
                        new ItemStack(TinkersDefense.partCloth, 1, 15),
                        0x242222));
        ...
        TConstructRegistry
                .addToolRecipe(tool_heaterShield, partArmorplate, TinkerTools.toughRod, partArmorplate, partRivet);

        // Wrench
        TConstructRegistry.addToolRecipe(tool_wrench, TinkerTools.handGuard, TinkerTools.toolRod, TinkerTools.binding);

        TConstructRegistry
                .addToolRecipe(tool_shears, TinkerTools.knifeBlade, TinkerTools.binding, TinkerTools.knifeBlade);
        ...
        // TConstructRegistry.addToolRecipe(tool_hookshot, TinkersDefense.partArmorplate, TinkerTools.toughRod,
        ...
        // GameRegistry.registerItem(tcInject.get(i), "debugger_" +
        // TConstructRegistry.tools.get(i).getLocalizedToolName());
        // }
        // }
    ...
    public void castmolten(Fluid fluid, int ID) {
        ...
        TConstructRegistry.getTableCasting().addCastingRecipe(
                ...
                new FluidStack(fluid, (int) (144 * 1.0D)),
                TConstructRegistry.getItemStack("arrowheadCast"),
                50);
        TConstructRegistry.getTableCasting().addCastingRecipe(
                new ItemStack(partArmorplate, 1, ID),
                new FluidStack(fluid, (int) (144 * 4.0D)),
                new ItemStack(metalPattern, 1, 2),
                50);
        TConstructRegistry.getTableCasting().addCastingRecipe(
                new ItemStack(partRivet, 1, ID),
                new FluidStack(fluid, (int) (144 * 0.5D)),
                new ItemStack(metalPattern, 1, 0),
                50);
        TConstructRegistry.getTableCasting().addCastingRecipe(
                new ItemStack(partClasp, 1, ID),
                new FluidStack(fluid, (int) (144 * 1.0D)),
                new ItemStack(metalPattern, 1, 1),
                50);
        TConstructRegistry.getTableCasting().addCastingRecipe(
                new ItemStack(partChainmaille, 1, ID),
                new FluidStack(fluid, (int) (144 * 4.0D)),
                new ItemStack(metalPattern, 1, 4),
                50);
    }
    ...
    public void buildParts(Item item, int meta) {
        ...
        tableCasting.addCastingRecipe(
                ...
                new ItemStack(item, 1, Short.MAX_VALUE),
                false,
                50);
        tableCasting.addCastingRecipe(
                cast,
        ...
        for (int iterTwo = 0; iterTwo < TinkerSmeltery.liquids.length; iterTwo++) {
            ...
            final ItemStack metalCast = new ItemStack(item, 1, liquidDamage[iterTwo]);
