...
public class TD_Config {
    ...
    public TD_Config(FMLPreInitializationEvent e) {
        ...
        transparency = config.getBoolean(
                "Should Transparent Textures be enabled?", "General Settings", true, "May help fps if disabled");
        ...
        ShearFortuneID =
                config.getInt("Fortune for Shears ID", "Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ...
        ArmorProtectionID =
                config.getInt("Protection ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorFireProtectionID =
                config.getInt("Fire Protection ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorBlastProtectionID =
                config.getInt("Blast Protection ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorProjectileProtectionID = config.getInt(
                "Projectile Protection ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorFeatherfallID =
                config.getInt("Featherfall ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorGlowstepID = config.getInt("Glowstep ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorFrostwalkerID =
                config.getInt("Frostwalker ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorFirewalkerID =
                config.getInt("Firewalker ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorDepthstriderID =
                config.getInt("Depthstrider ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorRebreatherID =
                config.getInt("Rebreather ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorNightvisionID =
                config.getInt("Nightvision ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorAntiBlindnessID =
                config.getInt("Anti Blindness ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ...
        ArmorAbsorptionID =
                config.getInt("Absorbtion ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ArmorJumpboostID =
                config.getInt("Jump Boost ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ...
        ArmorKnockbackResistID = config.getInt(
                "Knockback Resistance ID", "Armor Modifier Configs", count++, 18, Integer.MAX_VALUE, null);
        ...
        CorpseIvyModID =
                config.getInt("Corpse Drinker Ivy Modifier ID", "Botania Addon", count++, 18, Integer.MAX_VALUE, null);
        ManaRepairModID =
                config.getInt("Mana Repair Modifier ID", "Botania Addon", count++, 18, Integer.MAX_VALUE, null);
        TerraCoreModID = config.getInt("Terra Core Modifier ID", "Botania Addon", count++, 18, Integer.MAX_VALUE, null);
        ArmorPixieCoreModID =
                config.getInt("Elementium Core Modifier ID", "Botania Addon", count++, 18, Integer.MAX_VALUE, null);
        ArmorManaDiscountModID =
                config.getInt("Mana Embroidery Modifier ID", "Botania Addon", count++, 18, Integer.MAX_VALUE, null);

        ThaumcraftAddon =
                config.getBoolean("Enable Thaumcraft Addon", "Integration", true, "Requires Thaumcraft to use");
        RevealingModID =
                config.getInt("Revealing Modifier ID", "Thaumcraft Addon", count++, 18, Integer.MAX_VALUE, null);
        VisDiscountModID =
                config.getInt("Vis Discount Modifier ID", "Thaumcraft Addon", count++, 18, Integer.MAX_VALUE, null);
        ...
        BloodMagicAddon =
                config.getBoolean("Enable BloodMagic Addon", "Integration", true, "Requires BloodMagic to use");
        DivinationModID =
                config.getInt("Divination Modifier ID", "BloodMagic Addon", count++, 18, Integer.MAX_VALUE, null);
        SuppingModID = config.getInt("Supping Modifier ID", "BloodMagic Addon", count++, 18, Integer.MAX_VALUE, null);
        BloodOathModID =
                config.getInt("Blood Oath Modifier ID", "BloodMagic Addon", count++, 18, Integer.MAX_VALUE, null);
