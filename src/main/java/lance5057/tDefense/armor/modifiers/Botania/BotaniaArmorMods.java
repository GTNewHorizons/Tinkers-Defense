...
public class BotaniaArmorMods extends ModifiersBase {
    ...
    public void RegisterRecipes() {
        GameRegistry.addShapedRecipe(
                ...
                new Object[] { "sis", "idi", "sis", 'i', new ItemStack(ModItems.manaResource, 1, 7), 's',
    ...
    public void RegisterModifiers() {
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorManaDiscountModID,
                        "ManaEmbroidery",
                        1,
        ...
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorPixieCoreModID,
                        "ElementiumCore",
                        1,
