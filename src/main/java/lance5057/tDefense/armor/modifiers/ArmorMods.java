...
public class ArmorMods extends ModifiersBase {
    ...
    public ArmorMods() {
        super(
                new String[] { "Canister", "EmptyCanister", "Rebreather", "NightvisionGoggles", "Glowstep",
                        "Firewalker", "Frostwalker", "FeatherFall", "Flippers" },
                "modItemsArmor");
    ...
    public void RegisterRecipes() {
        GameRegistry.addShapedRecipe(
                ...
                new Object[] { "-c-", "ses", "-s-", 'c', new ItemStack(Items.coal, 1, 1), 's',
                        new ItemStack(Blocks.sapling, 1), 'e', new ItemStack(modItems, 1, 1) });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 1),
                new Object[] { "gsg", "lil", "gig", 'g', new ItemStack(Items.gold_nugget, 1, 0), 's',
                        new ItemStack(Items.slime_ball, 1, 0), 'l', new ItemStack(Items.dye, 1, 4), 'i',
                        new ItemStack(Items.iron_ingot, 1, 0) });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 2),
                new Object[] { "-s-", "eie", "-d-", 's', new ItemStack(Items.slime_ball, 1, 0), 'e',
                        new ItemStack(modItems, 1, 1), 'i', new ItemStack(TinkersDefense.partArmorplate, 1, 2), 'd',
                        new ItemStack(Items.dye, 1, 4) });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 3),
                new Object[] { "-s-", "eie", "-d-", 's', new ItemStack(Items.potionitem, 1, 8262), 'e',
                        new ItemStack(Blocks.glass_pane, 1, 0), 'i', new ItemStack(Items.iron_ingot, 1, 0), 'd',
                        new ItemStack(Items.dye, 1, 2) });

        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 4),
                new Object[] { "ggg", "ala", "ggg", 'g', new ItemStack(Blocks.glowstone, 1, 0), 'a',
                        new ItemStack(Items.glowstone_dust, 1, 0), 'l',
                        TConstructRegistry.getItemStack("lavaCrystal") });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 5),
                new Object[] { "lol", "oao", "lol", 'o', new ItemStack(Blocks.obsidian, 1, 0), 'a',
                        TConstructRegistry.getItemStack("ingotArdite"), 'l',
                        TConstructRegistry.getItemStack("lavaCrystal") });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 7),
                new Object[] { "fgf", 'g', new ItemStack(Items.gold_nugget, 1, 0), 'f',
                        new ItemStack(Items.feather, 1, 0) });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 6),
                new Object[] { "ili", "lcl", "ili", 'l', new ItemStack(Blocks.lapis_block, 1, 0), 'i',
                        new ItemStack(Blocks.ice, 1, 0), 'c', TConstructRegistry.getItemStack("ingotCobalt") });
        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 8),
                new Object[] { "-b-", "rlr", "-s-", 'b', new ItemStack(Items.leather_boots, 1, 0), 'l',
                        new ItemStack(Items.leather, 1, 0), 'r', new ItemStack(TinkerTools.toolRod, 1, 2), 's',
    ...
    public void RegisterModifiers() {
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ArmorRebreatherID,
                        "Rebreather",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ArmorNightvisionID,
                        "Nightvision",
        ...
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorAntiBlindnessID,
                        "AntiBlindness",
                        1,
                        ...
                        1,
                        null));
        // ModifyBuilder.registerModifier(new modifierBoolExclusive(new ItemStack[] {new ItemStack(Blocks.pumpkin, 1,
        // 0)}, TinkersDefense.config.ArmorPumpkinID, "Pumpkin", EnumChatFormatting.GOLD.toString(), "Pumpkin", new
        // String[] {"head"}, 1, null));
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ArmorHighstepID,
                        "Highstep",
        ...
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorSpeedID,
                        "Speed",
                        1,
        ...
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorJumpboostID,
                        "Jump",
                        1,
        ...
        // Excluding Cloth
        ModifyBuilder.registerModifier(
                new modifierProtection(
                        new ItemStack[] { new ItemStack(TinkersDefense.partArmorplate, 1, 2) },
                        TinkersDefense.config.ArmorProtectionID,
                        1,
        ...
        ModifyBuilder.registerModifier(
                new modifierProtection(
                        ...
                        TinkersDefense.config.ArmorFireProtectionID,
                        1,
        ...
        ModifyBuilder.registerModifier(
                new modifierProtection(
                        ...
                        TinkersDefense.config.ArmorBlastProtectionID,
                        1,
        ...
        ModifyBuilder.registerModifier(
                new modifierProtection(
                        ...
                        TinkersDefense.config.ArmorProjectileProtectionID,
                        1,
        ...
        ModifyBuilder.registerModifier(
                new modifierProtection(
                        ...
                        TinkersDefense.config.ArmorFeatherfallID,
                        1,
                        EnumChatFormatting.WHITE.toString(),
                        "Featherfall"));
        ModifyBuilder.registerModifier(
                new ModifierIntExclusive(
                        ...
                        TinkersDefense.config.ArmorAbsorptionID,
                        "HealthBoost",
                        1,
                        EnumChatFormatting.DARK_RED.toString(),
                        "HealthBoost",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ArmorGlowstepID,
                        "GlowStep",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ArmorFirewalkerID,
                        "Firewalker",
                        EnumChatFormatting.RED.toString(),
                        "Firewalker",
                        new String[] { "feet" },
                        1,
                        new String[] { "Frostwalker" }));
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        new ItemStack[] { new ItemStack(modItems, 1, 6) },
                        TinkersDefense.config.ArmorFrostwalkerID,
                        "Frostwalker",
                        EnumChatFormatting.BLUE.toString(),
                        "Frostwalker",
                        new String[] { "feet" },
                        1,
                        new String[] { "Firewalker" }));
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        new ItemStack[] { new ItemStack(modItems, 1, 8) },
                        TinkersDefense.config.ArmorDepthstriderID,
                        "Depthstrider",
        ...
        for (final ToolCore tool : TConstructRegistry.getToolMapping()) {
            ...
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.ArmorGlowstepID, "tinker", "glowstep", true);
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.ArmorFirewalkerID, "tinker", "firewalk", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool,
                    TinkersDefense.config.ArmorFrostwalkerID,
                    "tinker",
    ...
    public void UpdateWalker(ToolCore tool, ItemStack stack, World world, Entity entity, Material mat,
            Block replacement, int meta) {
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                ...
                if (block instanceof BlockLiquid) {
                    if (((BlockLiquid) block).getMaterial() == mat
                            && world.getBlockMetadata(x + (i - 2), y - 1, z + (j - 2)) == 0) {
                        world.setBlock(x + (i - 2), y - 1, z + (j - 2), replacement, meta, 3);
                        world.notifyBlocksOfNeighborChange(
                                x + (i - 2),
                                y - 1,
                                z + (j - 2),
                                world.getBlock(x + (i - 2), y - 1, z + (j - 2)));
                    }
                }
            }
        }
    ...
    public void UpdateGlowstep(ToolCore tool, ItemStack stack, World world, Entity entity) {
        ...
        if (glowTimer == 0) {
            if (world.getBlock(x, y, z) == Blocks.air && world.getBlock(x, y - 1, z).isNormalCube()) {
                ...
                // world.notifyBlocksOfNeighborChange(x + (i - 2), y - 1, z + (j - 2), world.getBlock(x + (i - 2), y -
                // 1, z + (j - 2)));
            }
            glowTimer = 8;
        ...
        if (player.getAir() <= 0) {
            ...
            for (i = 0; i < player.inventory.getSizeInventory(); i++) {
                if (player.inventory.getStackInSlot(i) != null
                        && player.inventory.getStackInSlot(i).getItem() == modItems
                    ...
                    if (used < 2 && canStack.stackSize == 1) {
                        ...
                        player.inventory.addItemStackToInventory(new ItemStack(modItems, 1, 1));
                        player.setAir(150);
                        used++;
                    }
                    if (used == 0 && canStack.stackSize >= 2) {
                        player.inventory.decrStackSize(i, 2);
                        player.inventory.addItemStackToInventory(new ItemStack(modItems, 2, 1));
                        player.setAir(300);
                        break;
                    }
                }
    ...
    public void UpdateNightvision(ToolCore tool, ItemStack stack, World world, Entity entity) {
        if (!((EntityPlayer) entity).isPotionActive(Potion.nightVision)
                || ((EntityPlayer) entity).getActivePotionEffect(Potion.nightVision).getDuration() < 1000) {
    ...
    public void UpdateHealthBoost(ToolCore tool, ItemStack stack, World world, Entity entity, NBTTagCompound tags) {
        if (!((EntityPlayer) entity).isPotionActive(21)) {
            ((EntityPlayer) entity)
                    .addPotionEffect(new PotionEffect(21, 100, tags.getInteger("HealthBoost") - 1, true));
        } else if (((EntityPlayer) entity).getActivePotionEffect(Potion.potionTypes[21]).getDuration() < 10) {
            ((EntityPlayer) entity).getActivePotionEffect(Potion.potionTypes[21])
                    .combine(new PotionEffect(21, 100, tags.getInteger("HealthBoost") - 1, true));
        }
    }
    ...
    public void Jump(LivingJumpEvent event) {
        if (event.entityLiving instanceof EntityPlayer) {
            ...
            if (player.getCurrentArmor(1) != null && player.getCurrentArmor(1).getItem() instanceof ArmorCore) {
                ...
                if ((armor instanceof TinkersRobe || armor instanceof TinkersChausses
                        || armor instanceof TinkersGrieves) && tags.hasKey("Jump")) {
    ...
    public void Highstep(TickEvent.PlayerTickEvent event) {
        ...
        if (event.player.getCurrentArmor(1) != null && event.player.getCurrentArmor(1).getItem() instanceof ArmorCore) {
            ...
            if ((armor instanceof TinkersRobe || armor instanceof TinkersChausses || armor instanceof TinkersGrieves)
                    && tags.hasKey("Highstep")
    ...
    // {
    // if(((EntityPlayer) event.target).getCurrentArmor(3).hasTagCompound() && ((EntityPlayer)
    // event.target).getCurrentArmor(3).getTagCompound().hasKey("InfiTool"))
    // {
