...
public class ArmorMods extends ModifiersBase {
    ...
    public void RegisterRecipes() {
        GameRegistry.addShapedRecipe(new ItemStack(modItems, 1, 0), new Object[] {
            "-c-",
            "ses",
            "-s-",
            'c',
        ...
        GameRegistry.addShapedRecipe(new ItemStack(modItems, 1, 3), new Object[] {
            "-s-",
            "eie",
            "-d-",
            's',
        ...
        GameRegistry.addShapedRecipe(new ItemStack(modItems, 1, 5), new Object[] {
            ...
            'a',
            TConstructRegistry.getItemStack("ingotArdite"),
            'l',
            TConstructRegistry.getItemStack("lavaCrystal")
        });
        GameRegistry.addShapedRecipe(new ItemStack(modItems, 1, 7), new Object[] {
            "fgf", 'g', new ItemStack(Items.gold_nugget, 1, 0), 'f', new ItemStack(Items.feather, 1, 0)
        });
        GameRegistry.addShapedRecipe(new ItemStack(modItems, 1, 6), new Object[] {
            ...
            'c',
            TConstructRegistry.getItemStack("ingotCobalt")
        });
    ...
    public void RegisterModifiers() {
        ...
        for (final ToolCore tool : TConstructRegistry.getToolMapping()) {
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorRebreatherID, "tinker", "rebreather", true);

            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorProtectionID, "tinker", "protection", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorFireProtectionID, "tinker", "fireprotection", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorBlastProtectionID, "tinker", "blastprotection", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorProjectileProtectionID, "tinker", "projprotection", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorFeatherfallID, "tinker", "featherfall", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorAbsorptionID, "tinker", "healthboost", true);

            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorGlowstepID, "tinker", "glowstep", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorFirewalkerID, "tinker", "firewalk", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorFrostwalkerID, "tinker", "frostwalk", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ArmorDepthstriderID, "tinker", "depthstrider", true);
        }
    ...
    public void UpdateWalker(
            ToolCore tool, ItemStack stack, World world, Entity entity, Material mat, Block replacement, int meta) {
                ...
                if (block instanceof BlockLiquid) {
                    if (((BlockLiquid) block).getMaterial() == mat
                        ...
                        world.notifyBlocksOfNeighborChange(
                                x + (i - 2), y - 1, z + (j - 2), world.getBlock(x + (i - 2), y - 1, z + (j - 2)));
                    }
                }
            }
        }
    ...
    public void UpdateHealthBoost(ToolCore tool, ItemStack stack, World world, Entity entity, NBTTagCompound tags) {
        ...
        } else if (((EntityPlayer) entity)
                        .getActivePotionEffect(Potion.potionTypes[21])
                        .getDuration()
                < 10) {
            ((EntityPlayer) entity)
                    .getActivePotionEffect(Potion.potionTypes[21])
    ...
    public void Jump(LivingJumpEvent event) {
        if (event.entityLiving instanceof EntityPlayer) {
            ...
            if (player.getCurrentArmor(1) != null && player.getCurrentArmor(1).getItem() instanceof ArmorCore) {
                ...
                if ((armor instanceof TinkersRobe
                                || armor instanceof TinkersChausses
                                || armor instanceof TinkersGrieves)
                        && tags.hasKey("Jump")) {
    ...
    public void Highstep(TickEvent.PlayerTickEvent event) {
        ...
        if (event.player.getCurrentArmor(1) != null
                && event.player.getCurrentArmor(1).getItem() instanceof ArmorCore) {
