...
public class TinkersHookshot extends ToolCore {
    ...
    @Override
    public void buildTool(int id, String name, @SuppressWarnings("rawtypes") List list) {
        final Item accessory = getAccessoryItem();
        final ItemStack accessoryStack = accessory != null ? new ItemStack(getAccessoryItem(), 1, id) : null;
        final Item extra = getExtraItem();
        final ItemStack extraStack = extra != null ? new ItemStack(extra, 1, id) : null;
        final ItemStack tool = ToolBuilder.instance.buildTool(
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        final EntityHookshotHook hook = new EntityHookshotHook(player.worldObj, player);
