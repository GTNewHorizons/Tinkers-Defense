...
@Optional.InterfaceList({
        ...
        @Optional.Interface(
                modid = "botania",
                iface = "vazkii.botania.common.item.equipment.tool.terrasteel.ItemTerraSword"), })
    ...
    public void RegisterRecipes() {
        CraftingManager.getInstance().getRecipeList().add(
                new ShapedOreRecipe(
                        ...
                        new Object[] { "fsf", "oio", "fgf", 'f',
                                ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_BELLETHORN), 'i',
                                new ItemStack(ModItems.keepIvy, 1, 0), 's', LibOreDict.MANA_STRING, 'g',
                                new ItemStack(TinkerTools.craftedSoil, 1, 3), 'o',
                                new ItemStack(ModItems.fertilizer, 1, 1) }));

        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 2),
                new Object[] { "sis", "idi", "sis", 'i', new ItemStack(ModItems.manaResource, 1, 4), 's',
                        new ItemStack(ModItems.manaResource, 1, 12), 'd', new ItemStack(ModItems.manaResource, 1, 2) });

        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 2),
                new Object[] { "sis", "idi", "sis", 'i', new ItemStack(ModItems.manaResource, 1, 4), 's',
                        new ItemStack(ModItems.manaResource, 1, 12), 'd', new ItemStack(ModItems.manaResource, 1, 1) });

        GameRegistry.addShapedRecipe(
                new ItemStack(modItems, 1, 3),
                new Object[] { "sis", "idi", "sis", 'i', new ItemStack(ModItems.manaResource, 1, 0), 's',
                        new ItemStack(ModItems.manaResource, 1, 12), 'd', new ItemStack(ModItems.manaTablet) });

        BotaniaAPI.registerManaAlchemyRecipe(new ItemStack(modItems, 1, 1), new ItemStack(modItems, 1, 0), 100000);
    }
    ...
    public void RegisterModifiers() {
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.CorpseIvyModID,
                        "CorpseIvy",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.TerraCoreModID,
                        "TerraCore",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ManaRepairModID,
                        "ManaCore",
                        EnumChatFormatting.AQUA.toString(),
                        "ManaCore",
                        new String[] {},
                        1,
                        new String[] { "CorpseIvy" }));

        for (final ToolCore tool : TConstructRegistry.getToolMapping()) {
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.CorpseIvyModID, "tinker", "corpseivy", true);
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.TerraCoreModID, "tinker", "terracore", true);
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.ManaRepairModID, "tinker", "manacore", true);
        }
    }
    ...
    public void UpdateTerraCore(ToolCore tool, ItemStack stack, World world, Entity entity, NBTTagCompound tags) {
        if (entity instanceof EntityPlayer) {
            ...
            if (player.getCurrentEquippedItem() == stack && player.swingProgress == check
                ...
                final EntityManaBurst burst = ((ItemTerraSword) ModItems.terraSword)
                        .getBurst(player, new ItemStack(ModItems.terraSword));
