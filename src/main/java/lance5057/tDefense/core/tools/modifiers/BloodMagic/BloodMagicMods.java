    ...
    public void RegisterRecipes() {
        GameRegistry.addRecipe(
                new ShapedBloodOrbRecipe(
                        ...
                        new Object[] { "sts", "cbc", "sos", 's', new ItemStack(ModItems.weakBloodShard, 1, 0), 't',
                                new ItemStack(TinkersDefense.partChainmaille, 1, 2), 'c',
                                new ItemStack(ModItems.standardBindingAgent, 1, 0), 'b',
                                new ItemStack(ModItems.energySword, 1, 0), 'o',
                                new ItemStack(ModItems.magicianBloodOrb, 1, 0) }));
    ...
    public void RegisterModifiers() {
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.BloodOathModID,
                        "BloodOath",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        ...
                        TinkersDefense.config.ScabbingModID,
                        "Scabbing",
        ...
        ModifyBuilder.registerModifier(
                new ModifierBoolExclusive(
                        new ItemStack[] { new ItemStack(ModItems.apprenticeBloodOrb, 1),
                                new ItemStack(ModItems.sacrificialDagger, 1) },
                        TinkersDefense.config.SuppingModID,
                        "Supping",
                        EnumChatFormatting.DARK_RED.toString(),
                        "Supping",
                        new String[] { "weapon" },
        ...
        for (final ToolCore tool : TConstructRegistry.getToolMapping()) {
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.BloodOathModID, "tinker", "bloodoath", true);
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.ScabbingModID, "tinker", "scabbing", true);
            TConstructClientRegistry
                    .addEffectRenderMapping(tool, TinkersDefense.config.SuppingModID, "tinker", "supping", true);
        }
    }
            ...
            if (event.source.getEntity() instanceof EntityPlayer) {
                ...
                if (heldItem != null && heldItem.getItem() != null && heldItem.getItem() instanceof ToolCore) {
                    ...
                    if (tags.hasKey("BloodOath") && EnergyItems.syphonBatteries(heldItem, player, 50)) {
                        event.entityLiving.addPotionEffect(new PotionEffect(Potion.weakness.id, 30, 2));
                    }

                    if (tags.hasKey("Supping")) {
                        SoulNetworkHandler.addCurrentEssenceToMaximum(
                                SoulNetworkHandler.getOwnerName(heldItem),
                                10,
                                SoulNetworkHandler.getMaximumForOrbTier(
                                        SoulNetworkHandler
                                                .getCurrentMaxOrb(SoulNetworkHandler.getOwnerName(heldItem))));
                    }
                }
            }
        }
