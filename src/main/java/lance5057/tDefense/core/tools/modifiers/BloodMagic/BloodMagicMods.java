...
public class BloodMagicMods extends ModifiersBase {
    ...
    public void RegisterRecipes() {
        GameRegistry.addRecipe(new ShapedBloodOrbRecipe(new ItemStack(modItems, 1, 0), new Object[] {
            "sts",
            "cbc",
            "sos",
            's',
            new ItemStack(ModItems.weakBloodShard, 1, 0),
            't',
            new ItemStack(TinkersDefense.partChainmaille, 1, 2),
            'c',
            new ItemStack(ModItems.standardBindingAgent, 1, 0),
            'b',
            new ItemStack(ModItems.energySword, 1, 0),
            'o',
            new ItemStack(ModItems.magicianBloodOrb, 1, 0)
        }));

        AltarRecipeRegistry.registerAltarRecipe(
                new ItemStack(modItems, 1, 1), new ItemStack(TinkersDefense.partCloth, 1, -1), 2, 12000, 10, 10, false);
    }
    ...
    public void RegisterModifiers() {
        ...
        ModifyBuilder.registerModifier(new ModifierBoolExclusive(
                new ItemStack[] {
                    new ItemStack(ModItems.apprenticeBloodOrb, 1), new ItemStack(ModItems.sacrificialDagger, 1)
                },
        ...
        for (final ToolCore tool : TConstructRegistry.getToolMapping()) {
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.BloodOathModID, "tinker", "bloodoath", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.ScabbingModID, "tinker", "scabbing", true);
            TConstructClientRegistry.addEffectRenderMapping(
                    tool, TinkersDefense.config.SuppingModID, "tinker", "supping", true);
        }
    }
                ...
                if (heldItem != null && heldItem.getItem() != null && heldItem.getItem() instanceof ToolCore) {
                    ...
                    if (tags.hasKey("Supping")) {
                        SoulNetworkHandler.addCurrentEssenceToMaximum(
                                ...
                                10,
                                SoulNetworkHandler.getMaximumForOrbTier(SoulNetworkHandler.getCurrentMaxOrb(
                                        SoulNetworkHandler.getOwnerName(heldItem))));
                    }
                }
            }
