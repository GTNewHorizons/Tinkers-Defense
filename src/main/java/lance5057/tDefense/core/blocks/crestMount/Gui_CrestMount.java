...
public class Gui_CrestMount extends GuiContainer {
    ...
    public void initGui() {
        super.initGui();
        buttonList.add(new GuiButton(1, guiLeft + 61, guiTop + 8, 18, 18, "Flip"));
        buttonList.add(new GuiButton(3, guiLeft + 79, guiTop + 8, 18, 18, "Flip"));
        buttonList.add(new GuiButton(2, guiLeft + 97, guiTop + 8, 18, 18, "Flip"));

        buttonList.add(new GuiButton(4, guiLeft + 79, guiTop + 63, 18, 18, "Flip"));
    }
        ...
        for (int i = 1; i < 5; i++) {
            if (button.id == i) {
                ...
                TinkersDefense.INSTANCE.sendToServer(
                        new Message_CrestMount(inventory.xCoord, inventory.yCoord, inventory.zCoord, inventory.flip));
            }
        }
    }
