...
public class TinkersDefense {
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        block_CrestMount = new CrestMount().setHardness(4.0F).setStepSound(Block.soundTypeMetal)
        ...
        block_ArmorAnvil = new ArmorAnvil().setHardness(4.0F).setStepSound(Block.soundTypeAnvil)
        ...
        // Queen's Gold
        item_QueensGoldIngot = new QueensGoldIngot().setCreativeTab(tabName).setMaxStackSize(64)
        ...
        // Dogbearium
        item_DogbeariumIngot = new DogbeariumIngot().setCreativeTab(tabName).setMaxStackSize(64)
    ...
    public void init(FMLInitializationEvent e) {
        ...
        TConstructRegistry
                .addToolMaterial(201, "AeonSteel", 4, 822, 1100, 3, 1.6F, 2, 0f, LIGHT_PURPLE.toString(), 0xb565e6);
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "Aeonsteel",
                new ItemStack(TinkerTools.toolShard, 1, 201),
                new ItemStack(TinkerTools.toolRod, 1, 201),
                201);
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "QueensGold",
                new ItemStack(TinkerTools.toolShard, 1, 202),
                new ItemStack(TinkerTools.toolRod, 1, 202),
                202);
        ...
        TConstructRegistry
                .addToolMaterial(203, "Dogbearium", 4, 600, 800, 2, 1.6F, 0, -2f, DARK_RED.toString(), 0x754200);
        ...
        PatternBuilder.instance.registerFullMaterial(
                ...
                2,
                "Dogbearium",
                new ItemStack(TinkerTools.toolShard, 1, 203),
                new ItemStack(TinkerTools.toolRod, 1, 203),
                203);
        ...
        // Shields
        TConstructRegistry
                .addToolRecipe(tool_roundShield, TinkerTools.largePlate, TinkerTools.toolRod, TinkerTools.frypanHead);
    ...
    public void postInit(FMLPostInitializationEvent e) {
        TConstructClientRegistry.toolButtons.add(
                TConstructClientRegistry.toolButtons.size(),
                new ToolGuiElement(
                        1,
                        0,
                        0,
        ...
        TConstructClientRegistry.tierTwoButtons.add(
                TConstructClientRegistry.tierTwoButtons.size(),
                new ToolGuiElement(
                        5,
                        0,
                        0,
