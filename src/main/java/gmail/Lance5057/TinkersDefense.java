...
public class TinkersDefense {
    ...
    public void init(FMLInitializationEvent e) {
        ...
        TConstructRegistry.addToolMaterial(
                201, "AeonSteel", 4, 822, 1100, 3, 1.6F, 2, 0f, LIGHT_PURPLE.toString(), 0xb565e6);
        ...
        TConstructRegistry.addToolMaterial(
                203, "Dogbearium", 4, 600, 800, 2, 1.6F, 0, -2f, DARK_RED.toString(), 0x754200);
        ...
        TConstructRegistry.addToolRecipe(
                tool_roundShield, TinkerTools.largePlate, TinkerTools.toolRod, TinkerTools.frypanHead);
