...
public class Renderer_CrestMount extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        if (tileEntity.getStackInSlot(0) != null) right = true;
        if (tileEntity.getStackInSlot(1) != null) left = true;
        if (tileEntity.getStackInSlot(3) != null) shield = true;
        ...
        if (tileEntity.getStackInSlot(slot) != null) {
            ...
            RenderItem.renderInFrame = true;
            GL11.glScalef(2f, 2f, 2f);
            if (rotation == 90) GL11.glTranslatef(0.3f, 0, 0.0f);
            if (rotation == -90) GL11.glTranslatef(-0.3f, 0, 0.0f);
